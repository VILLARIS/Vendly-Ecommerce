...
const menuItems = [
  ...
  { label: "Addresses", icon: MapPin, href: "#", active: true },
...
function AccountDashboard() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (!form.label.trim() || !form.street.trim() || !form.city.trim() || !form.country.trim()) {
      return;
    }
                  ...
                  {visibleCategories.map((cat) => {
                    ...
                    return (
                      <button
                        type="button"
                        key={cat.label}
                        onClick={() => updateField("label")({ target: { value: cat.label } })}
